    ...
    user && (
      <>
        <div className="flex gap-y-6 flex-wrap">
          <div className="flex flex-row justify-evenly w-full gap-x-4 items-center">
          ...
          <div className="w-full flex justify-center">
            <Link
              href={"/logout"}
              className="bg-pink-700 rounded-xl px-6 py-3 inline-block hover:bg-gray-100 duration-150"
            >
              Logout
            </Link>
          </div>
